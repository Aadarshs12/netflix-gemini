...
const Header = () => {
  ...
  return (
    <div className="relative">
      <div className="flex w-full absolute top-0 justify-between items-center z-30 bg-gradient-to-b from-black to-[#0a0a0a28] px-8 py-2 overflow-hidden">
        <div className="absolute inset-x-0 bottom-[-100%] h-full bg-gradient-to-b from-black/40 to-transparent scale-y-[-1] opacity-30 pointer-events-none"></div>
        <Link
          to={location.pathname === "/" ? "/" : "/browse"}
          onClick={handleLogoClick}
        >
          <img
            className="md:w-96 ffd400 w-60 object-cover"
            src={Logo1}
            alt="logo"
          />
        </Link>
                        ...
                        >
                          <div className="fixed inset-0 bg-[#00050d] flex items-center justify-center p-4 sm:p-6">
                            <DialogPanel className="w-full max-w-sm sm:max-w-md rounded-xl bg-white/5 p-6 backdrop-blur-2xl">
                              ...
                              <p className="mt-2 text-sm text-white font-sans">
                                Are you sure you want to sign out? Click "Yes"
